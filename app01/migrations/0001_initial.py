# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2019-09-01 13:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uid', models.CharField(help_text='微信用户绑定和CC视频统计', max_length=64, null=True, unique=True)),
        ...
        migrations.AddField(
            ...
            name='mentor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mentor', to='app01.Userinfo', verbose_name='导师'),
        ),
        migrations.AddField(
            model_name='order',
            name='account',
        ...
        migrations.AddField(
            ...
            name='mentor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='my_stu_homework_record', to='app01.Userinfo', verbose_name='导师'),
        ),
        migrations.AddField(
            model_name='homeworkrecord',
            name='student',
        ...
        migrations.AddField(
            model_name='enrolleddegreecourse',
            name='mentor',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='my_students', to='app01.Userinfo', verbose_name='导师'),
        ),
        migrations.AddField(
            model_name='enrolleddegreecourse',
            name='order_detail',
        ...
        migrations.AddField(
            model_name='comment',
            name='account',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.Userinfo', verbose_name='会员名'),
        ),
        migrations.AddField(
            model_name='comment',
            name='content_type',
